...
issue](https://github.com/cisagov/cool-sharedservices-freeipa/issues)
...
request](https://github.com/cisagov/cool-sharedservices-freeipa/pulls),
...
```console
cd cool-sharedservices-freeipa
pyenv virtualenv <python_version_to_use> cool-sharedservices-freeipa
pyenv local cool-sharedservices-freeipa
